import { Candidate as SharedCandidate } from '@votelab/shared-utils';

// Create a spatial-specific candidate type that requires x and y
export interface SpatialCandidate extends SharedCandidate {
    x: number;
    y: number;
    color: string;
}
